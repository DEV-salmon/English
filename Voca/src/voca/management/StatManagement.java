...
public class StatManagement {
    ...
    public int getCorrect_obj() {
        return correct_obj;
    }

    public void setCorrect_obj(int correct_obj) {
        this.correct_obj = correct_obj;
    }

    public int getWrong_obj() {
        return wrong_obj;
    }

    public void setWrong_obj(int wrong_obj) {
        this.wrong_obj = wrong_obj;
    }

    public int getCorrect_sub() {
        return correct_sub;
    }

    public void setCorrect_sub(int correct_sub) {
        this.correct_sub = correct_sub;
    }

    public int getWrong_sub() {
        return wrong_sub;
    }

    public void setWrong_sub(int wrong_sub) {
        this.wrong_sub = wrong_sub;
    }

    public int getTotal_obj() {
        return correct_obj + wrong_obj;
    }

    public int getTotal_sub() {
        return correct_sub + wrong_sub;
    }
    ...
    public double getStd_obj() {
        return Math.sqrt(getVar_obj());
    }

    public double getStd_sub() {
        return Math.sqrt(getVar_sub());
    }
